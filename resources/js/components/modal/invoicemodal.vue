<template>
    ...
    <div
        class="modal custom-modal modal-bg fade invoices-preview"
        id="invoices_preview"
        role="dialog"
    >
                                ...
                                <div class="card-body pb-0">
                                    <div class="invoice-item invoice-item-one">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div
                                                    class="invoice-logo d-flex justify-content-start"
                                                >
                                                    <img
                                    ...
                                    <div class="invoice-item invoice-item-bg">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                <div
                                                    class="invoice-info invoice-info-one border-0"
                                                >
                                                    <p>
                                    ...
                                    <!-- Invoices Item -->
                                    <div
                                        class="invoice-item invoice-table-wrap"
                                    >
                                        <div class="row">
                                            <div class="col-md-12">
    ...
    <div
        class="modal custom-modal modal-bg fade"
