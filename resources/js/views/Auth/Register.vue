  ...
  <div class="login-right-wrap">
    ...
    <form @submit.prevent="onSubmit">
      <div class="input-block">
        ...
        />
        <div class="invalid-feedback">{{ fieldError('first_name') }}</div>
      ...
      <div class="input-block">
        ...
        />
        <div class="invalid-feedback">{{ fieldError('last_name') }}</div>
        <div class="emailshow text-danger" id="email"></div>
      </div>
      <div class="input-block">
      ...
      <div class="input-block">
        ...
        />
        <span @click="showPassword1 = !showPassword1" class="toggle-password">
          <i
            :class="{
      ...
      <div class="input-block login-btn">
        <b-button type="submit" variant="primary me-1" class="btn btn-primary btn-block">
