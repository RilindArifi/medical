                ...
                >
                  <template #bodyCell="{ column, record }">
                    <template v-if="column.key === 'InvoiceNumber'">
                      <div><router-link to="/accounts/invoice-view">#INV-0001</router-link></div>
                    </template>
                    ...
                    <template v-else-if="column.key === 'Status'">
                      <div class="action-label">
                        <a class="custom-badge status-green" href="javascript:;"> Paid </a>
                      </div>
                    </template>
                      ...
                      <div class="text-end">
                        <div class="dropdown dropdown-action">
                          ...
                          <div class="dropdown-menu dropdown-menu-end">
                            <router-link class="dropdown-item" to="/accounts/edit-expense"
