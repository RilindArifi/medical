                  ...
                  <div class="col">
                    <div class="doctor-table-blk">
                      ...
                      <div class="doctor-search-blk">
                        ...
                        <div class="add-group">
                          <router-link to="add-payment" class="btn btn-primary add-pluss ms-2"
                ...
                >
                  <template #bodyCell="{ column, record }">
                    <template v-if="column.key === 'InvoiceNumber'">
                      <div>
                        <router-link to="invoice-view">{{ record.InvoiceNumber }}</router-link>
                      </div>
                    </template>
                      ...
                      <div class="text-end">
                        <div class="dropdown dropdown-action">
                          ...
                          <div class="dropdown-menu dropdown-menu-end">
                            <router-link class="dropdown-item" to="edit-payment"
...
export default {
  data() {
    return {
      ...
      columns,
      data,
      Patially: ['Select Payment Status', 'Paid', 'Un Paid', 'Patially Paid']
    }
  }
}
</script>
