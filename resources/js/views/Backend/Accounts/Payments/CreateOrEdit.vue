                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6 col-xl-6">
                    <div class="input-block local-forms">
                      ...
                      <vue-select :options="Doctors" id="doctors" placeholder="Enter Doctor Name" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-xl-6">
                    <div class="input-block local-forms">
                  ...
                  <div class="col-12 col-md-6 col-xl-6">
                    <div class="input-block local-forms">
                      ...
                      <vue-select :options="Pay" id="pay" placeholder="Select Payment Method" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-xl-6">
                    <div class="input-block local-forms">
...
export default {
  data() {
    return {
      ...
      Doctors: ['Enter Doctor Name', 'Dr.Galaviz Lalema', 'Dr.Bernardo James', 'Dr.Mark Hay Smith'],
