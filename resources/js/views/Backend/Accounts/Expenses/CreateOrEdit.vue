                ...
                <div class="row">
                  ...
                  <div class="col-12 col-md-6 col-xl-6">
                    <div class="input-block local-forms">
                      ...
                      <vue-select :options="Cheque" id="cheque" placeholder="Select Paid by" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-xl-6">
...
export default {
  data() {
    return {
      ...
      Bernardo: ['Select Purchase by', 'Bernardo James', 'Galaviz Lalema', 'Tarah Williams'],
      Cheque: ['Select Paid by', 'Paypal', 'Cheque', 'Debit Card'],
      Approved: ['Select Payment Status', 'Approved', 'Rejected', 'Pending']
    }
  }
}
</script>
