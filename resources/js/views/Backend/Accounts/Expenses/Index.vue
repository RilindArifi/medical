                  ...
                  <div class="col">
                    <div class="doctor-table-blk">
                      ...
                      <div class="doctor-search-blk">
                        ...
                        <div class="add-group">
                          <router-link to="add-expense" class="btn btn-primary add-pluss ms-2"
                ...
                <form>
                  <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-xl-4">
                      <div class="input-block local-forms">
                        <label>Paid by </label>
                        <vue-select :options="Paypal" id="paypal" placeholder="Select Paid by" />
                      </div>
                    </div>
                    <div class="col-12 col-md-6 col-xl-4">
                      ...
                      <div class="text-end">
                        <div class="dropdown dropdown-action">
                          ...
                          <div class="dropdown-menu dropdown-menu-end">
                            <router-link class="dropdown-item" to="edit-expense"
...
export default {
  data() {
    return {
      ...
      columns,
      data,
      Purchase: ['Select Purchase by', 'Bernardo James', 'Galaviz Lalema', 'Tarah Williams'],
