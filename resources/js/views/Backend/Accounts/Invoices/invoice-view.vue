                        ...
                        <div class="card-body">
                            ...
                            <div class="row custom-invoice">
                                <div class="col-12 col-md-6 m-b-20">
                                    ...
                                    <ul
                                        class="list-unstyled invoice-clinic mt-2"
                                    >
                                ...
                                <div class="col-12 col-md-6 m-b-20">
                                    <div class="invoice-details">
                                        ...
                                        <ul
                                            class="list-unstyled invoice-clinic"
                                        >
                            ...
                            <div class="table-responsive">
                                <table
                                    class="table table-hover border-0 custom-table invoice-table"
                                >
                                    <thead>
                                        <tr>
                                            <th>#</th>
                            ...
                            <div>
                                <div class="row invoice-payment">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="m-b-20">
                                            <div
                                                class="table-responsive no-border"
                                            >
                                                <table
                                ...
                                <div class="invoice-info">
                                    ...
                                    <p class="text-muted">
                                        ...
                                        adipiscing elit. Vivamus sed dictum
                                        ligula, cursus blandit risus. Maecenas
                                        eget metus non tellus dignissim aliquam
                                        ut a ex. Maecenas sed vehicula dui, ac
                                        suscipit lacus.
                                    </p>
                                </div>
                            </div>
