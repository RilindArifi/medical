                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="invoice-info">
                                <h5>
                                    Net Salary: $59698 (Fifty Nine Thousand Six
                                    Hundred and Ninety Eight Only)
                                </h5>
                                <p class="text-muted">
                                    Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Vivamus sed dictum ligula,
                                    cursus blandit risus. Maecenas eget metus
                                    non tellus dignissim aliquam ut a ex.
                                    Maecenas sed vehicula dui, ac suscipit
                                    lacus.
                                </p>
                            </div>
                            <div class="col-12">
