...
const route = useRoute(),
    ...
    onSubmit = async () => {
        ...
        await prepareRequest(() =>
            axiosClient
                .post(`settings/update`, buildFormData(state.value), {
            ...
            <div class="settings-menu-links">
                <ul class="nav nav-tabs menu-tabs">
                    <li
                        ...
                        :class="{ active: currentPath === 'general.settings' }"
                    >
                        <router-link
                            class="nav-link"
                    ...
                    <li
                        class="nav-item settings"
                        :class="{
                            active: currentPath === 'localization.settings',
                        }"
                    >
                        <router-link
                            class="nav-link"
                            :to="{ name: 'localization.settings' }"
                    ...
                    <li
                        class="nav-item settings"
                        :class="{
                            active: currentPath === 'business_hours.settings',
                        }"
                    >
                        <router-link
                            class="nav-link"
                            :to="{ name: 'business_hours.settings' }"
                            >Business Hours</router-link
                        >
                    </li>
                    <li
                        class="nav-item settings"
                        :class="{ active: currentPath === 'payment.settings' }"
                    >
                        <router-link
                            class="nav-link"
                    ...
                    <li
                        class="nav-item settings"
                        :class="{ active: currentPath === 'email.settings' }"
                    >
                        <router-link
                            class="nav-link"
                            :to="{ name: 'email.settings' }"
                            >Email Settings</router-link
                        >
                    </li>
                    <li
                        class="nav-item settings"
                        :class="{ active: currentPath === 'social.media' }"
                    >
                        <router-link
                            class="nav-link"
                    ...
                    <li
                        class="nav-item settings"
                        :class="{ active: currentPath === 'social.links' }"
                    >
                        <router-link
                            class="nav-link"
                    ...
                    <li
                        class="nav-item settings"
                        :class="{ active: currentPath === 'seo.settings' }"
                    >
                        <router-link
                            class="nav-link"
                            :to="{ name: 'seo.settings' }"
                            >SEO Settings</router-link
                        >
                    </li>
                    <li
                        class="nav-item settings"
                        :class="{ active: currentPath === 'others.settings' }"
                    >
                        <router-link
                            class="nav-link"
                            :to="{ name: 'others.settings' }"
                            >Others</router-link
                        >
                    </li>
                </ul>
