                    ...
                    <form>
                        <div class="settings-form">
                            <div class="input-block">
                                <div
                                    class="row"
                                    v-for="holiday in exceptionDates.holidays"
                                    :key="holiday.date"
                                >
