                    ...
                    <div class="card-body">
                        ...
                        <div class="personal-activity">
                            <div class="personal-icons status-grey">
                                <img
                                    src="../../../../../assets/img/icons/medal-01.svg"
                                    alt=""
                                />
                            </div>
                        ...
                        <div class="personal-activity">
                            <div class="personal-icons status-green">
                                <img
                                    src="../../../../../assets/img/icons/medal-02.svg"
                                    alt=""
                                />
                            </div>
                            <div class="views-personal">
                        ...
                        <div class="personal-activity mb-0">
                            <div class="personal-icons status-orange">
                                <img
                                    src="../../../../../assets/img/icons/medal-03.svg"
                                    alt=""
                                />
                            </div>
                            <div class="views-personal">
                    ...
                    <div class="card-body">
                        <div class="tab-content-set">
                            <ul class="nav">
                                ...
                                <li>
                                    <router-link
                                        :to="{ name: 'doctors.view.setting' }"
                                        :class="
                                            route.name.includes(
                                                'doctors.view.setting',
                                            )
                                                ? 'active'
                                                : ''
                                        "
