            ...
            <div class="col-md-12">
                ...
                <div class="doctor-profile-head">
                    <div class="profile-bg-img">
                        <img
                            src="https://preclinic.dreamstechnologies.com/vuejs/template/img/profile-bg.cf1af559.jpg"
                            alt="Profile"
                        />
                    </div>
                    <div class="row">
                                ...
                                <div class="profile-user-img">
                                    ...
                                    >
                                        <div class="uplod d-flex">
                                            <label
                                                class="file-upload profile-upbtn mb-0"
                                            >
                                                <img
                        ...
                        <div
                            class="col-lg-4 col-md-4 d-flex align-items-center"
                        >
                        ...
                        >
                            <div class="follow-btn-group">
                                ...
                                <button
                                    type="submit"
                                    class="btn btn-info message-btns"
                                >
                                    Message
                                </button>
                            </div>
