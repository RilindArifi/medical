...
const model = useModelOperations("roles"),
    ...
    deleteAction = (id) => {
        model.deleteAction(id).then(() => {
            message.success({ content: "Role was successfully deleted." });
            fetchData(false);
        });
    },
    restoreAction = (id) => {
        model.restoreAction(id).then(() => {
            message.success({ content: "Role was successfully restored." });
            fetchData(false);
        });
    },
    forceDeleteAction = (id) => {
        model.forceDeleteAction(id).then(() => {
            message.success({
                content: "Role was successfully force deleted.",
            });
            fetchData(false);
        });
    };
