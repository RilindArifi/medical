                        ...
                        <div class="doctor-widget border-right-bg">
                            ...
                            <div class="doctor-content dash-count flex-grow-1">
                                <h4>
                                    ...
                                    <!--                  />-->
                                    <span>/85</span
                                    ><span class="status-green">+60%</span>
                                </h4>
                                <h5>Appointments</h5>
                            </div>
                        </div>
                                ...
                                <div class="income-value">
                                    ...
                                    <p>
                                        <span class="passive-view"
                                            ><i
                                                class="feather-arrow-up-right me-1"
                                            ></i
                                            >40%</span
                                        >
                                        vs last month
                        ...
                        <div class="card-body">
                            <div class="teaching-card">
                                ...
                                <ul class="activity-feed">
                                    ...
                                    >
                                        <div
                                            class="dolor-activity hide-activity"
                                        >
                                            <ul class="doctor-date-list mb-2">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <i
                                                            class="fas fa-circle me-2 active-circles"
                                                        ></i
                                                        >08:00
                                                        <span
                                                            >Andrea Lalema</span
                                                        ><span
                                                            ...
                                                            >Ongoing
                                                            <i
                                                                class="feather-chevron-down ms-2"
                                                            ></i
                                                        ></span>
                                                    </a>
                                                    <ul
                                                        class="doctor-sub-list dropdown-menu"
                                                    >
                                                        <li
                                                            class="patient-new-list dropdown-item"
                                                        >
                                                            Patient<span
                                                                >Marie
                                                                kennedy</span
                                                            ><a
                                                                href="javascript:;"
                                                                class="new-dot status-green"
                                                                ><i
                                                                    class="fas fa-circle me-1 fa-2xs"
                                                                ></i
                                                                >New</a
                                                            >
                                                        </li>
                                                        ...
                                                        <li
                                                            class="schedule-blk mb-0 pt-2 dropdown-item"
                                                        >
                                                            <ul
                                                                class="nav schedule-time"
                                                            >
                                                                <li>
                                                                    <a
                                                                        href="javascript:;"
                                                            ...
                                                            <a
                                                                class="btn btn-primary appoint-start"
                                                                >Start
                                                                Appointment</a
                                                            >
                                                        </li>
