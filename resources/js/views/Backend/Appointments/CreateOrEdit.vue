...
const
    ...
    onSubmit = async () => {
      ...
      await prepareRequest(() => (modelId ? models.updateAction(modelId, state.value) : models.storeAction(state.value))
          .then((response) => {
            message.success(`Appointment was successfully ${modelId ? 'updated' : 'created'}.`)
            router.push({name: 'appointments.edit', params:{id: response.data.data.id}})
          }))
    }
...
<template>
  <div class="page-wrapper">
    <div class="content">
      <!-- Page Header -->
      <breadcrumb :title="$t('appointments.appointmentList')" text="Book Appointment" path="/appointments" />
      <!-- /Page Header -->
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
                ...
                <div class="row">
                      ...
                      <div class="col-4">
                        ...
                        <div class="col-12 col-md-6 col-xl-12">
                          <div class="input-block local-forms">
                            ...
                            <patient-select v-model:value="state.patient_id" />
                          </div>
                        </div>
                      </div>
                      <div class="col-8" v-if="!state.patient_id">
                        <div class="row">
                          <div class="col-12">
                            <div class="form-heading">
                              <h4>New Patient</h4>
                          ...
                          <general :state="state" :field-error="fieldError"/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-6 col-xl-4">
                    <div class="input-block local-forms cal-icon">
                      ...
                      <a-date-picker
                          ...
                          :format="dateFormat()"
                          :class="{ 'is-invalid': fieldError('date') }"
                      />
                      <div class="invalid-feedback">{{ fieldError('date') }}</div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-xl-4">
                    <div class="input-block local-forms">
                  ...
                  <div class="col-12 col-md-6 col-xl-6">
                    <div class="input-block local-forms">
                      ...
                      <doctor-select
                          ...
                          :class="{ 'is-invalid': fieldError('doctor_id') }"
                      />
                      <div class="invalid-feedback">{{ fieldError('doctor_id') }}</div>
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-xl-6">
                    <div class="input-block local-forms">
                      <label>Treatment <span class="login-danger">*</span></label>
                        <input
                            v-model="state.treatment"
                            class="form-control"
                            type="text"
                            placeholder=""
                            :class="{ 'is-invalid': fieldError('treatment') }"
                        />
                      <div class="invalid-feedback">{{ fieldError('treatment') }}</div>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="doctor-submit text-end">
                      ...
                      <router-link :to="{name: 'appointments.index'}"  class="btn btn-primary cancel-form">Cancel</router-link>
                    </div>
                  </div>
                </div>
              </form>
